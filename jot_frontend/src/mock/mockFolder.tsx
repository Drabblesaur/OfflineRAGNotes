  ...
  notes: [
    {
                ...
                content: [
                  {
                    ...
                    content: [
                      {
                        type: "text",
                        text: "Finalize roadmap with design team",
                      },
                    ],
                  },
                ],
      ...
      favorite: true,
      tags: ["work", "planning"],
      date: new Date("2026-03-01T00:00:00"), // user-set note date
      lastEditedAt: new Date("2026-03-08T09:15:00"), // last auto-saved
    },
    {
      id: "note-2",
                ...
                content: [
                  {
                    type: "paragraph",
                    content: [
                      { type: "text", text: "The Pragmatic Programmer" },
                    ],
                  },
                ],
              },
